...
$("#fields-table").on("click", ".delete-button", function () {
    ...
    const url = `http://localhost:8081/spring-boot-final/api/v1/field/getfieldcode/${fieldName}`;
    $.ajax({
        url: url,
        method: "GET",
        headers: {
        ...
        success: function (fieldCode) {
            ...
            $.ajax({
                url: "http://localhost:8081/spring-boot-final/api/v1/field/" + fieldCode,
                method: "DELETE",
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("token"),
                },
...
function updateFields() {
    ...
    const url = `http://localhost:8081/spring-boot-final/api/v1/field/${fieldName}`;
    $.ajax({
        url: url,
        method: "PATCH",
        headers: {
