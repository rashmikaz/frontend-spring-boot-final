...
function loadVehicle() {
    $.ajax({
        url: "http://localhost:8081/spring-boot-final/api/v1/vehicle",
        type: "GET",
        headers: {
...
$("#vehicle-table").on("click", ".delete-button", function () {
    ...
    $.ajax({
        url: `http://localhost:8081/spring-boot-final/api/v1/vehicle/getvehiclecode/${licenseNumber}`,
        method: "GET",
        headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
        },
        success: function (vehicleCode) {
            ...
            $.ajax({
                url: `http://localhost:8081/spring-boot-final/api/v1/vehicle/${vehicleCode}`,
                method: "DELETE",
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("token"),
                },
