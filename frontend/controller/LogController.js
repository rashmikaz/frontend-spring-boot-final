...
function fetchCropNames() {
    $.ajax({
        url: " http://localhost:8081/spring-boot-final/api/v1/crop/getallcropnames",
        type: "GET",
        headers: {
...
function loadLogs() {
    $.ajax({
        url: "http://localhost:8081/spring-boot-final/api/v1/log",
        method: "GET",
        headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
        },
...
$("#log-table").on("click", ".delete-button", function () {
    ...
    $.ajax({
        url: `http://localhost:8081/spring-boot-final/api/v1/log/getlogcode/${logDesc}`,
        method: "GET",
        headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
        },
        success: function (logCode) {
            ...
            $.ajax({
                url: `http://localhost:8081/spring-boot-final/api/v1/log/${logCode}`,
                method: "DELETE",
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("token"),
                },
...
function updateLog() {
    ...
    const url = `http://localhost:8081/spring-boot-final/api/v1/log/getlogcode/${logDesc}`;
