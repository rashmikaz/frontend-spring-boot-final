...
function loadEquipment() {
    $.ajax({
        url: "http://localhost:8081/spring-boot-final/api/v1/equipment",
        type: "GET",
...
$("#equipment-table").on("click", ".delete-button", function () {
    ...
    $.ajax({
        url: `http://localhost:8081/spring-boot-final/api/v1/equipment/getequipId/${equipmentName}`,
        method: "GET",
        headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
        },
        success: function (equipmentId) {
            ...
            $.ajax({
                url: `http://localhost:8081/spring-boot-final/api/v1/equipment/${equipmentId}`,
                method: "DELETE",
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("token"),
                },
