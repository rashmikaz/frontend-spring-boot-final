...
function loadStaff() {
    $.ajax({
        url: "http://localhost:8081/spring-boot-final/api/v1/staff",
        type: "GET",
        headers: {
...
$("#staff-table").on("click", ".delete-button", function () {
    ...
    $.ajax({
        url: `http://localhost:8081/spring-boot-final/api/v1/staff/getstaffid/${firstName}`,
        method: "GET",
        headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
        },
        success: function (id) {
            ...
            $.ajax({
                url: `http://localhost:8081/spring-boot-final/api/v1/staff/${id}`,
                method: "DELETE",
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("token"),
                },
...
function updateStaff() {
    ...
    $.ajax({
        ...
        success: function (staffId) {
            ...
            $.ajax({
                url: `http://localhost:8081/spring-boot-final/api/v1/staff/${staffId}`,
                type: "PATCH",
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("token"),
                },
